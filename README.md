...
Where X can be any number from 3 to infinity. To switch to your custom icon set, change _ icon_var_ inside _settings.lua_ to the number you chose to replace X.
If the custom icons have any size other than 40 * 40 px, change the _icon_width_ and _icon_height_ inside _settings.lua_ to match your icons. All icons in a set must have the same size.
